...
| **P3+ — Versioning fichiers / collection** | `PUT /datas/{id}` versioning de fichiers (#4, réconciliation SHA-1), `PUT /collections/{id}` (métadonnées de collection), UI web de push | futur | élevé |
